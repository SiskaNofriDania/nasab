                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Kelola Pengguna Utama</h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <form action="">
                                <div class="card-body pb-0 pt-5 mt-3 ms-2">
                                    <div class="input-group">
                                        ...
                                        <a href="{{route('user_nasab.tambahNasab')}}" class="btn btn-success mb-0 d-flex align-items-center me-2 rounded-3"><span class="fa fa-plus-circle fa-2x me-2"></span>Tambah Nasab </a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        <th
                                            class="text-uppercas text-center text-secondary text-xxs font-weight-bolder opacity-7" style="width: 5% !important; padding: 0px !important;">
                                            No</th>
                                        <th
                                ...
                                <tbody>
                                    @forelse ($people as $p)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <h6 class="mb-0 text-sm text-center">{{$p->telepon}}</h6>
                                            </td>
                                            <td class="align-middle">
